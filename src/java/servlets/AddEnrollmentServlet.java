...
public class AddEnrollmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int enrollResult = enrollmentDao.addEnrollment(enrollment);
        if (enrollResult == 1) {
            request.getSession().setAttribute("message", "you success to enroll this course");
        } else {
            request.getSession().setAttribute("message", "you already enrolled this course");
        }
        ...
        //            out.println("<html>");
        //            out.println("<head>");
        //            out.println("<title>Servlet AddEnrollmentServlet</title>");
        //            out.println("</head>");
        //            out.println("<body>");
        //            out.println("<h1>Servlet AddEnrollmentServlet at " + request.getContextPath() + "</h1>");
        //            out.println("</body>");
        //            out.println("</html>");
        //        }
    }
