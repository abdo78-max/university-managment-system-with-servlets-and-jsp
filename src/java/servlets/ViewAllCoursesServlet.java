...
public class ViewAllCoursesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Course> courses = new ArrayList<>(courseDao.viewCourses());
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet ViewAllCoursesServlet</title>");
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet ViewAllCoursesServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
