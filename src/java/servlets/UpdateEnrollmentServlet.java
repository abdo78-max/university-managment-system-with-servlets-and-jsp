...
public class UpdateEnrollmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int enrollResult = enrollmentDao.updateEnrollment(enrollment, updateCourse);
        if (enrollResult == 1) {
            request.getSession().setAttribute("message", "you successed to update this enrollment");
        } else {
            request.getSession().setAttribute("message", "you failed to update this enrollment");
        }
        response.sendRedirect("updateenrollment2.jsp");
//        try (PrintWriter out = response.getWriter()) {
//            /* TODO output your page here. You may use following sample code. */
//            out.println("<!DOCTYPE html>");
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet UpdateEnrollmentServlet</title>");
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet UpdateEnrollmentServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
