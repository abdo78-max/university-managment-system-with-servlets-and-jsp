...
public class SearchEnrollmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (selectedEnrollment != null) {
            ...
            request.setAttribute("message", "No enrollment found");
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet SearchEnrollmentServlet</title>");
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet SearchEnrollmentServlet at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
